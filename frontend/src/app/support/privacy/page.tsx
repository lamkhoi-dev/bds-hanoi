    ...
    <div className="min-h-screen bg-background py-10">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 prose max-w-none text-gray-600">
          ...
          <p className="mb-4">Chào mừng bạn đến với Nhà Đất Xứ Nghệ. Chúng tôi tôn trọng quyền riêng tư của bạn và cam kết bảo vệ dữ liệu cá nhân của người dùng. Chính sách này giải thích cách chúng tôi thu thập, sử dụng, chia sẻ và bảo vệ thông tin của bạn khi sử dụng trang web và ứng dụng của chúng tôi, bao gồm cả khi bạn đăng nhập thông qua các dịch vụ của bên thứ ba như Facebook hoặc Google.</p>
          ...
          <ul className="list-disc pl-5 space-y-3 bg-gray-50 p-4 rounded-xl border border-gray-100">
            ...
            <li><strong>Bước 4:</strong> Tìm ứng dụng <strong>Nhà Đất Xứ Nghệ</strong> trong danh sách.</li>
            <li><strong>Bước 5:</strong> Nhấn vào <strong>Xóa (Remove)</strong> để gỡ bỏ quyền truy cập.</li>
            <li><strong>Bước 6 (Quan trọng):</strong> Để yêu cầu chúng tôi xóa vĩnh viễn toàn bộ dữ liệu của bạn (bao gồm email, tin đăng, số điện thoại) khỏi hệ thống máy chủ, vui lòng gửi email tới <strong>contact@nhadatxunghe.vn</strong> với tiêu đề &quot;Yêu cầu xóa dữ liệu tài khoản&quot; hoặc gọi điện trực tiếp tới số Hotline hỗ trợ. Chúng tôi sẽ thực hiện xóa hoàn toàn dữ liệu của bạn trong vòng 24 - 48 giờ.</li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li><strong>Email:</strong> contact@nhadatxunghe.vn</li>
            <li><strong>Hotline:</strong> 0868126826</li>
            <li><strong>Địa chỉ:</strong> Nghệ An, Việt Nam</li>
          </ul>
        </div>
      </div>
    </div>
