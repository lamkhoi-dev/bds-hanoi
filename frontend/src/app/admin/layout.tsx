...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const allNavItems = [
    ...
    // Chỉ ADMIN — khách chốt khi rà 12/9. Trước đây MOD thấy menu này nhưng bấm vào thì
    // mọi thao tác ghi đều bị backend chặn 403 (news.controller.ts checkAdmin), một trạng
    // thái gây khó hiểu hơn là ẩn hẳn.
    { label: 'Quản lý Tin tức', icon: <FileText size={20} />, href: '/admin/news', roles: ['ADMIN', 'SUPER_ADMIN'] },
